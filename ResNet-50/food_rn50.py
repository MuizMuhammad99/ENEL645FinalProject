...
# Function to calculate mean and standard deviation of dataset
...
# Create a temporary data loader to calculate dataset statistics
temp_loader = DataLoader(ImageFolder("food-101/train", transform=transforms.ToTensor()), batch_size=32, shuffle=True, num_workers=2)
...
best_model_path = 'bestmodel_44_rn50.pth'
