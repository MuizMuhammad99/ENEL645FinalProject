...
class FoodClassifier(nn.Module):
    def __init__(self, num_class, input_shape, transfer=False):
        ...
        # Initializing the feature Extractor (ResNet34)
        self.feature_extract = models.resnet34(weights=transfer)
...
def train_model(model, criterion, optimizer, scheduler, num_epochs=15):
    ...
    PATH = 'bestfoodpath_resnet34_0.0001lr.pth'
    # best loss function
    best_loss = 1e+20
...
net = FoodClassifier(num_classes, (3,224,224), True)
net.load_state_dict(torch.load('bestfoodpath_resnet34_0.0001lr.pth'))
net.to(device)
